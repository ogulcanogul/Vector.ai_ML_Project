...
def getGradientTransformers(model, weight_decay=None, excluded_vars=None, clipnorm=None, clipvalue=None):

    gradient_transformers = []
    if (weight_decay is not None) and weight_decay > 0.0:
        gradient_transformers.append(WeightRegularizer(model=model,
